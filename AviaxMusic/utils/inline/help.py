...
def help_pannel(_, START: Union[bool, int] = None):
    ...
    # Third row - Page navigation buttons
    third = [
        InlineKeyboardButton(text=_["BACK_PAGE"], callback_data="help_prev"),
        InlineKeyboardButton(text=_["BACK_BUTTON"], callback_data="settingsback_helper"),
        InlineKeyboardButton(text=_["NEXT_PAGE"], callback_data="help_next"),
    ]

    # Use second or third set based on START
    mark = third if START else first
    ...
    upl = InlineKeyboardMarkup(
        [
            ...
            mark,  # This is your navigation/footer row
        ]
    )
    return upl
